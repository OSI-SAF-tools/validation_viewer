...
path_area_config = '/home/jol/Documents/code/old/validation_viewer/config/projection/areas.cfg'
...
RESULTS_PATHS = {'OSI450_validation_NH_2016-12-01_results.csv': ('Standard Deviation', 'Northern Hemisphere'),
                 'OSI450_validation_SH_2016-12-01_results.csv': ('Standard Deviation', 'Southern Hemisphere')}
